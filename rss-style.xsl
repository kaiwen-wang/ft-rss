...
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="/">
    <html xmlns="http://www.w3.org/1999/xhtml" lang="en">
      <head>
        <title> RSS Feed | <xsl:value-of select="/atom:feed/atom:title" />
        </title>
        <meta charset="utf-8" />
      ...
      <body>
        <main class="layout-content">
          <dk-alert-box type="info">
            ...
            into your newsreader. Visit <a
              href="https://aboutfeeds.com">About Feeds
            </a> to learn more and get started. It’s free. </dk-alert-box>
          <div class="py-7">
            ...
            <xsl:for-each select="/atom:feed/atom:entry">
              <div class="pb-7">
                <div class="text-2 text-offset"> Published on <xsl:value-of
                    select="substring(atom:published, 0, 11)" />
                </div>
